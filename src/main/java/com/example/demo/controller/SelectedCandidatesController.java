...
public class SelectedCandidatesController {
	...
	public String getJobSeekersByApplyId(@PathVariable int applyId, HttpSession session, Model model)
	{
	    ...
	    ResponseEntity<JobApply> response = restTemplate.exchange("http://localhost:8091/CareerCrafters1/api/v1/getApplication/" + applyId,
		    ...
		    ResponseEntity<Test> response1 = restTemplate.exchange("http://localhost:8091/CareerCrafters1/api/v1/findTestByVacancyId/" +JobApply.getVacancies().getVacancyId(),
			...
			ResponseEntity<String> response3 = restTemplate.exchange("http://localhost:8091/CareerCrafters1/api/v1/addSelectedCandidates", HttpMethod.POST,
					entity, String.class);
			...
			ResponseEntity<String> response4 = restTemplate.exchange("http://localhost:8093/EmailMicroService/sendMail", HttpMethod.POST,
	...
	public ModelAndView addSelectedCandidates(@ModelAttribute("selectedCandidates") SelectedCandidates selectedCandidates, HttpSession session)
	{
	    ...
	    restTemplate.exchange("http://localhost:8091/CareerCrafters1/api/v1/addSelectedCandidates", HttpMethod.POST, requestEntity, Void.class);
