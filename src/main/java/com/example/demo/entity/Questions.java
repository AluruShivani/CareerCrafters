...
public class Questions {
	...
	public Questions(int questionId, Test test, Vacancies vacancies, String question, String option1, String option2,
			String option3, String option4, String correct, String score) {
		super();
